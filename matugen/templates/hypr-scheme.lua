-- Rendered by matugen to ~/.config/hypr/scheme/current.lua (gitignored in
-- the repo; hyprland.lua falls back to scheme/default.lua on first boot).
-- Only the M3 roles the hypr configs actually read need to exist, but the
-- full set is rendered for future use.
return {
