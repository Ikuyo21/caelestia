...
hl.bind(vars.kbRestoreLock, function()
    hl.dispatch(hl.dsp.exec_cmd("qs -c caelestia -d"))
...
hl.bind(
    "CTRL + SUPER + ALT + R",
    hl.dsp.exec_cmd("qs -c caelestia kill; sleep .1; qs -c caelestia -d"),
    { release = true }
)
...
hl.bind("SUPER + Period", hl.dsp.exec_cmd("pkill fuzzel || caelestia-emoji"))
hl.bind(
    "CTRL + SHIFT + ALT + V",
