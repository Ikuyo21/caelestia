...
-- Opaque Apps (Image Viewers, Creative Software, Games) as they prefer native transparency as required
-- Alacritty is deliberately NOT here: its blur/transparency comes from the
-- generic opacity rule + Hyprland blur (see CLAUDE.md Theming architecture)
hl.window_rule({
    match = {
        class =
...
hl.window_rule({ match = { class = "Alacritty", title = "nmtui" }, tag = "+float_60_70" })
